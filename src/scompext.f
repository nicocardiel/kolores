...
C Galaxy: Savage and Mathis (1979) -> Linear interpolation in Table 2.
          IF((LAMBDA.GE.1000.0).AND.(LAMBDA.LE.34000.))THEN
            ...
            Y(27)= 0.16
            NPTOS=27
            K_LAMBDA=LININTERP(NPTOS,X,Y,LAMBDA,IFLAG,N1,N2)
            LOK=.TRUE.
          END IF
C..............................................................................
...
C Table 2 and linear interpolation in Table 3.
          ...
          ELSEIF(XX.LT.2.7)THEN
            ...
            Y(18)=4.64
            NPTOS=18
            K_LAMBDA=LININTERP(NPTOS,X,Y,XX,IFLAG,N1,N2)
...
C Galaxy: Fitzpatrick (1999)
     ...
     +       7.97809E-04*RV*RV*RV-4.45636E-05*RV*RV*RV*RV
            ...
            NPTOS=9
            IMODE=1
            CALL CUBSPL(X,Y,NPTOS,IMODE,SPLS,SPLA,SPLB,SPLC)
            I0=5
            CALL CUBSPLX(X,Y,SPLA,SPLB,SPLC,NPTOS,I0,XX,K_LAMBDA)
            LOK=.TRUE.
...
C SMC: Prevot et al (1984) + Bouchet et al. (1985)
          ...
          ELSEIF(XX.LE.7.84)THEN
            ...
            Y(01)=-2.47
            NPTOS=30
            K_LAMBDA=LININTERP(NPTOS,X,Y,XX,IFLAG,N1,N2)+RV
            LOK=.TRUE.
          END IF
C..............................................................................
...
C
C Input: N,X,Y,X0
C Output: LININTERP(function), IFLAG, N1, N2
C
